...
def create_app(config_class=Config):
    ...
    from backend.local_auth import local_auth_bp
    ...
    from backend.routes.resume_ai import resume_ai_bp
    from backend.routes.internship_recommendations import internship_recommendations_bp
    from backend.supabase_auth import supabase_auth_bp

    # Optional blueprint: resume_enhancer (skip if heavy deps missing)
    resume_enhancer_bp = None
    try:
        from backend.routes.resume_enhancer import resume_enhancer_bp as _resume_enhancer_bp
